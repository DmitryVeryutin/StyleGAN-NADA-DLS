...
Общий принцип действия сети: используют два предобученных генератора, один из которых сохраняют неизменным (Gfrozen), а другой обучают изменять картинку (Gtrain), чтобы сделать ее похожей на целевой промпт.
...
Примеры работы (слева адаптация сгенерированной картинки, справа - инвертированного реального фото, взятого из фотостока, над картинками - описание стартовой картинки -> описание целевой картинки):
- photo -> sketch
<p float="centered">
